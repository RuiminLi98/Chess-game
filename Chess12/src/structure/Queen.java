...
/**
 * This is the subclass Queen which extends the abstract class Cell. 
 * The Queen class implements the movement of Queen piece on the board. 
 */

public class Queen extends Cell{
	/**
	 * Initialize the Queen object with cellName, pieceName, isAlive, x, y.
	 * @param cellName The cell's name, such as "##" or "  ",which is under the Queen piece. 
	 * @param pieceName The Queen piece's name, such as "wQ" or "bQ".
	...
	/**
	 * This method performs the movement of a Queen piece from current point to targeting point.
	...
	/**
	 * This method is going to search all of the possible location where the Queen can reach.
	 * @param currX The x-coordinate of Queen
	 * @param currY The y-coordinate of Queen
